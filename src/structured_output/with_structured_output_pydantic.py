...
class Review(BaseModel):
    summary: Annotated[str, Field(description="A brief summary of the product review.")]
    key_themes: Annotated[List[str], Field(description="A list of key themes discussed in the review.")]
    sentiment: Annotated[Literal["pos", "neg"], Field(description="The overall sentiment of the review, either 'pos' for positive or 'neg' for negative.")]
